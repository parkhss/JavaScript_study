...
// Set 생성
const members3 = new Set();

// add 메소드
members3.add('영훈'); // Set(1) {"영훈"}
members3.add('윤수'); // Set(2) {"영훈", "윤수"}
members3.add('영훈'); // Set(2) {"영훈", "윤수"}
members3.add('영훈'); // Set(2) {"영훈", "윤수"}
members3.add('동욱'); // Set(3) {"영훈", "윤수", "동욱"}
members3.add('동욱'); // Set(3) {"영훈", "윤수", "동욱"}
members3.add('동욱'); // Set(3) {"영훈", "윤수", "동욱"}
members3.add('태호'); // Set(4) {"영훈", "윤수", "동욱", "태호"}
members3.add('동욱'); // Set(4) {"영훈", "윤수", "동욱", "태호"}
members3.add('태호'); // Set(4) {"영훈", "윤수", "동욱", "태호"}
members3.add('태호'); // Set(4) {"영훈", "윤수", "동욱", "태호"}
